...
import 'package:netflix/application/home/home_bloc.dart' as _i14;
import 'package:netflix/application/new&hot/new_and_hot_bloc.dart' as _i11;
...
import 'package:netflix/domain/new&hot/upcoming_movie_service.dart' as _i5;
...
import 'package:netflix/infrastructure/new&hot/upcoming_movie_impl.dart' as _i6;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i5.UpcomingMovieService>(() => _i6.UpcomingMovieImpl());
    ...
    gh.factory<_i11.NewAndHotBloc>(
        () => _i11.NewAndHotBloc(gh<_i5.UpcomingMovieService>()));
    gh.factory<_i12.DownloadsBloc>(
        () => _i12.DownloadsBloc(gh<_i7.IDownloadsRepo>()));
